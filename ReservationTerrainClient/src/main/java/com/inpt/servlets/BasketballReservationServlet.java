...
/**
 * Servlet implementation class BasketballReservationServlet
 */
public class BasketballReservationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("tousReservationJour", reservationDao.obtenirLesHeursRésérvées(selectedDate, "Basketball"));
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            reservationDao.ajouterReservation(reservation, userName, "basketball");
            request.setAttribute("selectedDate", date);
            request.setAttribute("tousReservationJour", reservationDao.obtenirLesHeursRésérvées(date, "Basketball"));
