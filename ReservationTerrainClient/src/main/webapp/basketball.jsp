...
<html lang="fr">
  <head>
    ...
    <title>Réserver un Terrain de Basket</title>
    <!-- CSS FILES -->
  ...
  <input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
              ...
              <div class="col-lg-8 col-12">
                <div class="heroText">
                  <h1 class="text-white mb-lg-5 mb-4">
                    Réservez Votre Terrain de Basketball en Un Clic !
                  </h1>
                </div>
              </div>
            </div>
    ...
    <main>
      ...
      <div class="pb-5 controls">
        <form id="date-form" action="basketball" method="get">
          ...
          <div class="row">
           ...
           <c:forEach var="hour" begin="9" end="20">
            ...
            <div class="col-12 text-center mt-5">
              <form id="reservation-form" action="basketball" method="post">
