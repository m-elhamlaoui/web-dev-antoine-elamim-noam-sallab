...
<html lang="fr">
  <head>
    ...
    <title>Réserver un Terrain de Foot</title>
    <!-- CSS FILES -->
...
<%-- <c:out value="${request.getAttribute("status")}"></c:out> --%>
              ...
              <div class="col-lg-8 col-12">
                <div class="heroText">
                  <h1 class="text-white mb-lg-5 mb-4">
                    Réservez Votre Terrain de Football en Un Clic !
                  </h1>
                </div>
              </div>
            </div>
    ...
    <main>
      ...
      <div class="pb-5 controls">
        <form id="date-form" action="football" method="get">
          ...
          <div class="row">
           ...
           <c:forEach var="hour" begin="9" end="20">
            ...
            <div class="col-12 text-center mt-5">
              <form id="reservation-form" action="football" method="post">
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-12 mx-auto my-lg-0 my-4">
              ...
              <ul class="footer-menu">
                ...
                <li class="footer-menu-item">
                  <a href="#section_3" class="footer-menu-link">À propos</a>
                </li>
